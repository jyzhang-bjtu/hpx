...
namespace hpx { namespace parallel { HPX_INLINE_NAMESPACE(v1)
{
    ...
    namespace detail
    {
        ...
        {
            replace_if(char const* const name = "replace_if")
              : replace_if::algorithm(name)
            {}
    ...
    namespace detail
    {
        /// \cond NOINTERNAL
        template <typename Iter>
        struct replace : public replace_if<Iter>
        {
            replace()
              : replace("replace")
            {}
            ...
            {
                with_value<T1> pred(old_value);
                return replace_if::sequential(first, last, pred, new_value,
                    std::forward<Proj>(proj));
            }
            ...
            {
                with_value<T1> pred(old_value);
                return replace_if::parallel(
                    std::forward<ExPolicy>(policy), first, last, pred, new_value,
                    std::forward<Proj>(proj));
            }
        };
        /// \endcond
    ...
    namespace detail
    {
        ...
        {
            replace_copy_if(char const* const name = "replace_copy_if")
              : replace_copy_if::algorithm(name)
            {}
    ...
    namespace detail
    {
        /// \cond NOINTERNAL
        template <typename IterPair>
        struct replace_copy : public replace_copy_if<IterPair>
        {
            replace_copy()
              : replace_copy_if("replace_copy")
            {}
            ...
            {
                with_value<T> pred(old_value);
                return replace_copy_if::sequential(first, last, dest, pred,
                    new_value, std::forward<Proj>(proj));
            }
            ...
            {
                with_value<T> pred(old_value);
                return replace_copy_if::parallel(
                    std::forward<ExPolicy>(policy), first, last, dest, pred,
                    new_value, std::forward<Proj>(proj));
            }
        };
        /// \endcond
