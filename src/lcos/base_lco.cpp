...
///////////////////////////////////////////////////////////////////////////////
HPX_DECLARE_ACTION(hpx::lcos::base_lco::set_event_action,
    hpx::lcos::base_lco::set_event_action);
HPX_ACTION_USES_MESSAGE_COALESCING_NOTHROW_DEFINITION(
    hpx::lcos::base_lco::set_event_action, "lco_set_value_action",
    std::size_t(-1), std::size_t(-1))

HPX_DECLARE_ACTION(hpx::lcos::base_lco::set_exception_action,
    hpx::lcos::base_lco::set_exception_action);
HPX_ACTION_USES_MESSAGE_COALESCING_NOTHROW_DEFINITION(
